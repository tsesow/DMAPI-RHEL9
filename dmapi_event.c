...
EXPORT_SYMBOL(dm_send_data_event);	/* TSS */
EXPORT_SYMBOL(dm_send_namesp_event);	/* TSS */
EXPORT_SYMBOL(dm_send_mount_event);	/* TSS */
EXPORT_SYMBOL(dm_send_destroy_event);	/* TSS */
EXPORT_SYMBOL(dm_send_unmount_event);	/* TSS */
